...
class Content(ContentTemplate):
  ...
  def refresh_contents(self):
    """Get dubs from the database and pass them to the helper method"""
  ...
  def text_box_searchContent_pressed_enter(self, **event_args):
    """This method is called when the user presses Enter in the 'search' text box"""
    self.searchContent()
  ...
  def button_showAll_click(self, **event_args):
    """This method is called when the 'showAll' button is clicked"""
  ...
  def delete_dub(self, audioRow, **event_args):
    """This method is called when the the deletion is confirmed"""
